...
export default function PrimitivesLayout({
  ...
  const sidebarItems = [
    ...
    { href: '/primitives/aspect-ratio', label: 'Aspect Ratio' },
    ...
    { href: '/primitives/carousel', label: 'Carousel' },
    ...
    { href: '/primitives/menubar', label: 'Menubar' },
    { href: '/primitives/navigation-menu', label: 'Navigation Menu' },
